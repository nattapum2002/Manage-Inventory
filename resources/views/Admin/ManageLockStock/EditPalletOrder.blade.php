                ...
                <form action="">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-3">
                            ...
                            <input type="text" class="form-control" id="product_unit" name="product_unit" value="{{$item->item_um}}" readonly>
                        </div>                    
                    </div>
                    <div class="row mb-3">
                        <div class="col-3">
                            <label for="product_qty">จํานวนจ่ายสินค้า</label>
                            <input type="text" class="form-control" id="product_qty" name="product_qty" value="{{$item->quantity2}}">
                        </div>
                        <div class="col-3">
                            <label for="product_unit">หน่วยสินค้า</label>
                            <input type="text" class="form-control" id="product_unit" name="product_unit" value="{{$item->item_um2}}" readonly>
                        </div>
                        <div class="col-3">
                            <label for="">หมายเหตุ</label>
                            <input type="text" class="form-control" id="" name="pallet_detail_note" value="{{$item->product_order_note ?? 'ไม่มี'}}">
                        </div>
                        {{-- <div class="col">
