        ...
        <section class="card shadow">
            <article class="card-header bg-primary text-white">
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-4">
                        <h5>ห้องเก็บ: {{ $Pallets[0]->warehouse ?? 'N/A' }}</h5>
                    </div>
                    <div class="col-md-3 col-sm-4 text-center">
            ...
            <article class="card-body">
                ...
                <div class="text-center">
                    <a type="button" href="{{ route('Em.Work.palletSubmit', $Pallets[0]->id) }}"
                        class="btn btn-success {{ $Pallets[0]->status == 1 ? 'disabled' : '' }}">เสร็จสิ้น</a>
                </div>
            </article>
