...
class IncentiveController extends Controller
{
    ...
    {
        $arrangeicentive = DB::table('lock_team_user')
            ->select(
                'users.name',
                'users.surname',
                'users.user_id',
        ...
        foreach ($arrangeicentive as $key => $value) {
        ...
        // dd($arrangeicentive);
        return view('Admin.ManageIncentive.IncentiveArrangeWorkerDetail',compact('arrangeicentive','total_incentive_Kg' ,'date'));
    }
}
